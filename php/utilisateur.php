...
<html lang="fr">
  ...
  <body>
    ...
    <main class="utilisateur">
      ...
      <section class="resume card">
        ...
        <div class="header-profil">
          <div class="profil-credits">
            <h2>Bienvenue Paul</h2>
            <p><strong>Nombre de crédits : 48</strong></p>
          </div>
          <!-- photo de profil -->
        ...
        <div class="role-choice">
          <h2>Choississez votre rôle</h2>
          <div class="button">
            <button class="button" type="button" aria-label="chauffeur">
              Chauffeur
            </button>
            <button class="button" type="button" aria-label="passager">
              Passager
            </button>
            <button class="button" type="button" aria-label="duo">
              Les deux
            </button>
          </div>
        </div>
      ...
      <section class="informations-chauffeur card">
        <h2>Pour être chauffeur, veuillez rensigner ces informations</h2>
              ...
              <div class="vehicule">
                <label for="circulation"
                  ><span
                    ...
                    role="img"
                    >calendar_month</span
                  >1ère mise en circulation :</label
                >
                <input
                  type="date"
                  name="circulation"
      ...
      <!-- Ajouter un voyage -->
      <form method="post" class="voyage card" autocomplete="on">
        <fieldset class="add-voyage">
          ...
          <div class="voyage-fields">
            ...
            <div class="voyage">
              <label for="fixer-prix"
                ...
                >Fixer le prix</label
              >
              <input type="text" name="fixer-prix" id="fixer-prix" required />
            </div>
          ...
          <p>
            Afin de garantir le bon fonctionnement de la plateforme, 2 crédits
            vous seront débités.
          </p>
        </fieldset>
      </form>
        ...
        <table class="a-venir card">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>18</td>
              <td>
                <button type="button" aria-label="Annuler ce trajet">
                  Annuler
                </button>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>19</td>
              <td>
                <button type="button" aria-label="Démarrer ce trajet">
                  Démarrer
                </button>
              </td>
            </tr>
