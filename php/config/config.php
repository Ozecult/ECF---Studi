...
return [
    ...
    'app' => [
        'name' => 'EcoRide',
        'env' => $_ENV['APP_ENV'] ?? 'development', // Changé pour développement
        'debug' => $_ENV['APP_DEBUG'] ?? true, // Activé pour développement
        'url' => $_ENV['APP_URL'] ?? 'http://localhost', // Changé en HTTP
    ...
    'session' => [
        ...
        'cookie_samesite' => 'Lax', // Changé de Strict à Lax pour développement
        'cookie_lifetime' => 0,
        'gc_maxlifetime' => 7200,
