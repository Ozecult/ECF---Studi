document.addEventListener("DOMContentLoaded", function () {
  ...
  boutonMenu.addEventListener("click", function (e) {
    ...
    if (
      clickedElement.classList.contains("burger-icon") ||
      (clickedElement.textContent &&
        clickedElement.textContent.trim() === "menu")
    ) {
      ...
      clickedElement.classList.contains("material-symbols-outlined") &&
  ...
  document
    .querySelectorAll("#menu-profile a, #mobile-nav-menu a")
    .forEach((link) => {
